...
export const APP_PERMISSION_DEFAULT_API_KEY = 'default';
export const APP_PERMISSION_TODO_ADMIN_API_KEY = 'todo_admin';
export const APP_PERMISSIONS = [APP_PERMISSION_DEFAULT_API_KEY, APP_PERMISSION_TODO_ADMIN_API_KEY];
